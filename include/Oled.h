...
#include "Arduino.h"  //
#include "Wire.h"	  // TWI/I2C library for Arduino
...
// IIC参数它只需要两根信号线，一根是串行数据线SDA，另一根是串行时钟线SCL。
#define SDA_PIN 13		// 串行数据线SDA
#define SCL_PIN 12		// 串行时钟线SCL
#define Oled_SLAVE 0x3c // 屏幕地址，这是固定的
...
#define YLevel 0xB0	   // 驱动地址偏移B0-B3共四页
#define Brightness 127 // 屏幕初始化亮度0-255
#define WIDTH 128	   // 宽度
#define HEIGHT 32	   // 高度
#define PAGE_SIZE 4	   // 竖直分辨率/8 也就是32位是四个字节
